...
@section('section')
	...
	<div class="title">
		<h3 class="font-weight-bold">Настройки аккаунта</h3>
	</div>
	<hr>
	<div class="form-group row">
		...
		<div class="col-sm-9">
			...
			<p class="">
				<a href="#" class="font-weight-bold change-profile-photo" data-toggle="collapse" data-target="#avatarCollapse" aria-expanded="false" aria-controls="avatarCollapse">Сменить фото профиля</a>
			</p>
			<div class="collapse" id="avatarCollapse">
				...
				<div class="card card-body">
					<div class="custom-file mb-1">
						...
						<label class="custom-file-label" for="avatarInput">Выберите фото</label>
					</div>
					<p><span class="small font-weight-bold">Загрузка в формате jpeg или png. До: <span id="maxAvatarSize"></span></span></p>
					<div id="previewAvatar"></div>
					<p class="mb-0"><button type="submit" class="btn btn-primary px-4 py-0 font-weight-bold">Загрузить</button></p>
				</div>
				</form>
			</div>
			<p class="">
				<a class="font-weight-bold text-muted delete-profile-photo" href="#">Удалить фото профиля</a>
			</p>
		</div>
	</div>
	<form method="post">
		@csrf
		<div class="form-group row">
			<label for="name" class="col-sm-3 col-form-label font-weight-bold">Имя</label>
			<div class="col-sm-9">
				<input type="text" class="form-control" id="name" name="name" placeholder="Your Name" value="{{Auth::user()->profile->name}}" v-pre>
			</div>
		</div>
		<div class="form-group row">
			<label for="website" class="col-sm-3 col-form-label font-weight-bold">Вебсайт</label>
			<div class="col-sm-9">
				<input type="text" class="form-control" id="website" name="website" placeholder="Website" value="{{Auth::user()->profile->website}}" v-pre>
			</div>
		</div>
		<div class="form-group row">
			<label for="bio" class="col-sm-3 col-form-label font-weight-bold">Биография</label>
			<div class="col-sm-9">
		...
		<!-- TODO: Убраны другие языки -->
		<!-- <div class="form-group row">
			<label for="language" class="col-sm-3 col-form-label font-weight-bold">Язык</label>
			<div class="col-sm-9">
			...
			<div class="col-sm-9">
				...
				<div class="help-text">
					<span class="small text-muted">
						{{$storage['percentUsed']}}% использовано
					</span>
